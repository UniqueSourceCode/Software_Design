...
/**
 * An edge of a graph, given by a pair of two vertices of type N.
 *
...
public record Edge<N extends Comparable<N>>(@NotNull N source, @NotNull N target) implements Comparable<Edge<N>> {
    ...
    /**
     * Compares this edge with another edge. Edges are first compared by their source
     * vertices; if source vertices are equal, they are compared by their target vertices.
