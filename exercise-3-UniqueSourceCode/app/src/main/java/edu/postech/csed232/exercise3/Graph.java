...
public interface Graph<N extends Comparable<N>> {
    ...
    /**
     * Returns true if this graph contains a given vertex. For example, consider a graph
    ...
    /**
     * Returns true if this graph contains an edge from source to target. Consider a graph
     * with vertices {v1, v2, v3, v4} and edges {(v1,v2), (v1,v4), (v2, v4)}. Then,
     * containsEdge(v1,v2) = true and containsEdge(v2,v3) = false.
     *
    ...
    /**
     * Returns the set of adjacent vertices of a given vertex. If the vertex is not in
